...
public struct PWMControl : OptionSet, Equatable, Hashable {
    ...
    public static let channel2Enabled        = PWMControl(rawValue: 1 << 8)
    ...
    public static let channel1Enabled        = PWMControl(rawValue: 1 << 0)
...
extension PWMControl : CustomDebugStringConvertible {
    ...
    public var debugDescription: String {
        ...
        if contains(.channel2Enabled) { parts.append(".channel2Enabled") }
        ...
        if contains(.channel1Enabled) { parts.append(".channel1Enabled") }
